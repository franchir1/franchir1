...
My work centers on **end-to-end data analysis projects** built on real-world datasets, with strong attention to:
...
- **SQL (PostgreSQL)**  
  Analytical queries, JOINs, CTEs, window functions, time-based analysis

- **Data Modeling**  
  Star schema design, fact table grain definition, dimension normalization
...
End-to-end analytical project based on NYC Department of Health inspection data.
...
- KPI normalization using relevant denominators  
...
- Professional experience in:
  ...
  - Sales Engineering  
  with direct exposure to operational data, KPIs, and reporting
